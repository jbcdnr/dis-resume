...
\usepackage[a4paper, margin={.5in, .5in}, bmargin=.7in, footskip=2.5em]{geometry}
...
\title{\Huge Distributed Information Systems Summary\\\vspace{.5em}
\Large Prof. Aberer, M. Catasta, Spring 2016}
\author{P. Aeby, C. Bertrand, J.-B. Cordonnier, L. Ottet, B. Raemy, A. Semple, S. Speierer}
\date{\today}
...
\include{2-semanticWeb}

\include{3-4-graph-databases}
\stepcounter{section}

\include{5-frequent-itemsets}

% Sebastien S
\include{6-clustering-classification}

% Sebastien S
\include{7-classification-pipeline}

% JB
\include{8-social-graph}

% JB
\include{9-recommender-systems}

\include{10-vector-space-model}

% Alexis
\include{11-inverted-files}

% Alexis
\include{12-advanced-retrieval}

\include{13-link-analysis}
